...
import { Drawer, Box, Typography, IconButton, Tooltip, Badge, styled, alpha, Switch, useTheme } from '@mui/material'
        ...
        borderStyle: "solid"
              ...
              <Box >
                ...
                <Box display='flex' justifyContent="space-between">
                  ...
                  <Typography style={{ fontSize: '18px', fontWeight: '500', color: 'white', paddingLeft: '14px',paddingTop:'15px'}}>
                      Bật/tắt thông báo: 
                    </Typography>
                 <Box paddingTop="8px">
                 <Android12Switch />
